...
<head>
    <meta charset="utf-8" />
    <title>Vérification du statut | ONPC</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta content="Statut de la demande ONPC" name="description" />
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center mt-sm-5 mb-4 text-white-50">
                            ...
                            <p class="mt-3 fs-15 fw-medium">Vérification du statut de demande ONPC</p>
                        </div>
                    </div>
                </div>
